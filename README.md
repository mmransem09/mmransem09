...
| Cryptography (encryption/decryption, hashing), CIA triad and non-repudiation, VB.NET <br> Secure SDLC, Key management & distribution (PKI), Security testing & validation | <a href="https://github.com/mmransem09/ASA-Lab/blob/main/IDPSLab.md"> Secure Chat Application </a>|
